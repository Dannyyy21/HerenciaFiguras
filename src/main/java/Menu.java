...
public class Menu {
    ...
    public void menu() {
        ...
        switch (operacion) {
            ...
            case 5:
                System.out.println("**Area y Perimetro de un Cubo**");
                Cubo cubo = new Cubo();
                cubo.area();
                cubo.perimetro();
                break;
            ...
            case 6:
                System.out.println("**Area y Perimetro de una Esfera**");
            ...
            case 7:
                System.out.println("**Area y Perimetro de una Piramide Triangular**");
